...
{
    FILE *fp ;
    fp = fopen("d:\\c programsss\\reFiles\\alltrains.dat","rb");
    if(fp == NULL)
    {
    fp = fopen("d:\\c programsss\\reFiles\\alltrains.dat","wb");
    train t[4] ={
...
if(check_booking(&q.train_no,&q.p_class) >=2)
{
    ...
    FILE *fp ;
    fp = fopen("d:\\c programsss\\reFiles\\trains.dat","ab+");

    if(fp == NULL)
    {
        fp =fopen("d:\\c programsss\\reFiles\\trains.dat","wb");
        fclose(fp);
        fp = fopen("d:\\c programsss\\reFiles\\trains.dat","ab+");
    }
...
int last_ticket_no()
{
    FILE *fp ;
    passenger no ;
    fp = fopen("d:\\c programsss\\reFiles\\trains.dat","rb");
...
void view_ticket(int no)
{
    ...
    passenger q ;
   fp = fopen("d:\\c programsss\\reFiles\\trains.dat","rb");
ft = fopen("d:\\c programsss\\reFiles\\alltrains.dat","rb");
...
int cancel_ticket(int ticket_no)
{
    ...
    passenger pr , qr ;
    fp = fopen("d:\\c programsss\\reFiles\\trains.dat","rb+");
    fc = fopen("d:\\c programsss\\reFiles\\trains1.dat","wb+");
    ...
    while(fread(&pr,sizeof(passenger),1,fp)==1)
    {
        if(pr.ticketno == ticket_no)
        {
            ...
            fclose(fp);
            fclose(fc);
remove("d:\\c programsss\\reFiles\\trains.dat");
rename("d:\\c programsss\\reFiles\\trains1.dat","d:\\c programsss\\reFiles\\trains.dat");
            return 1 ;
        }
    }
